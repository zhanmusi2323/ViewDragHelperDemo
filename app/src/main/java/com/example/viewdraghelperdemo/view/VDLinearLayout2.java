...
public class VDLinearLayout2 extends LinearLayout{
    ScrollView topView;
    Button dragBtn;
    ...
    public VDLinearLayout2(Context context) {
        super(context);
        init();
    }

    public VDLinearLayout2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public VDLinearLayout2(Context context, AttributeSet attrs, int defStyleAttr) {
